...
void pinyin_utf8(const char* inbuf, char* outbuf, bool m_blnSimaple = false, bool polyphone_support = false, bool m_blnFirstBig = false, bool m_blnAllBiG = false, bool m_LetterEnd = false, bool m_unknowSkip = true, bool m_filterPunc = true)
{
...
int findLetter(int nCode, char* strValue)
{
	...
	case 7666:
		...
		break;
		strcpy_s(strValue, HZ2PY_MAX_PINYIN_SIZE, "1845 餐");
		break;
	case 6315:
	case 7693:
	case 7911:
...
void pinyin_gb2312(const char * inbuf, char * outbuf, bool m_blnSimaple = false, bool polyphone_support = false, bool m_blnFirstBig = false, bool m_blnAllBiG = false, bool m_LetterEnd = false, bool m_unknowSkip = true, bool m_filterPunc = true) {
	/*
